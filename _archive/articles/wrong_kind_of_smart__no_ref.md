...
IMAGE: [The Wrong Kind of Smart] - ./images/wrong_kind_of_smart_01.webp
...
IMAGE: [A better map of the work] - ./images/wrong_kind_of_smart_02.webp
...
IMAGE: [The operating model] - ./images/wrong_kind_of_smart_03.webp
...
For the formal version of this argument, including the decomposition of work into context complexity and output scope, the pricing of failure, and the move from one-step routing to iterative rerouting, see the full white paper.

## References

1. Economic Evaluation of LLMs
2. Cost-of-Pass: An Economic Framework for Evaluating Language Models
...
5. AI Tokenomics for Software Engineering: A Practical Economic Model for Iterative Model Routing
