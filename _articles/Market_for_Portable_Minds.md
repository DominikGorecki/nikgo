...
description: "Productive intelligence should remain portable as AI enters work: workers carry generalized context, companies protect specialized context, and mobility is negotiated rather than absorbed into one central brain."
...
The first version of the AI economy will look perfectly reasonable. It will arrive as an internal productivity initiative, not as an announcement that markets are ending.

A company will connect an agent system to documents, tickets, dashboards, customer records, code, policies, calendars, and workflows. The system will retrieve knowledge, draft decisions, assign work, and improve processes. Executives will value the control, security teams the containment, and finance the leverage. No one needs to identify as a central planner to build a highly centralized machine.

AI makes centralization look clean: one operating layer and one context bank, with every improvement feeding back into a corporate intelligence system. At first this is simply management with better tools. The twentieth-century managerial corporation already moved substantial coordination out of open markets and into administrative systems, a shift Alfred Chandler described as the rise of the “visible hand” ([The Visible Hand][6]). AI gives that hand more memory and speed.
...
Job displacement is only part of the risk. The individual may also cease to be the basic unit of economic learning. If people cannot own and carry a meaningful share of their AI-enabled capability, the value will accumulate wherever the agents live: inside companies, platforms, and governments.
...
This exchange has always been messy. A worker leaves with knowledge the company helped create, while the company keeps systems the worker helped build. Some of it is documented or protected by contract, and much of it lives in a brain that cannot be audited in any practical sense.

Economists have long had names for pieces of this. Human capital is one of them ([Human Capital][5]). Friedrich Hayek’s classic argument about dispersed knowledge is another: the knowledge required to coordinate an economy is not given to any one mind or institution, but scattered across people and local circumstances ([The Use of Knowledge in Society][3]). Ronald Coase explained that firms exist partly because markets have coordination costs, which means the boundary between firm and market is always a practical bargain, not a sacred line ([The Nature of the Firm][4]).
...
AI makes the boundary harder to ignore because some of that learning can now live outside the person.

## The Human+Agent Pair

In a future labor market, a worker may bring more than a résumé and portfolio. She may also bring a portable context layer containing workflows, patterns, prompts, evaluation criteria, domain heuristics, operating principles, and agent skills accumulated over years.

“Skill” here should be understood broadly. It might resemble the way current agent platforms talk about tools, instructions, and reusable capabilities, whether in agent frameworks, Claude-style skills, or coding assistants such as Codex ([OpenAI Agents SDK][7], [Claude Skills][8], [OpenAI Codex][9]). But the deeper idea is not tied to any product. A skill is useful context that helps an agent act well. It is the difference between a generic assistant and one that knows how a particular professional thinks, checks, prioritizes, and ships.
...
The productive unit is the human+agent pair, not the agent alone. The person still decides what matters, interprets ambiguity, senses politics, weighs tradeoffs, and recognizes when a technically correct answer is professionally foolish. The agent carries part of the accumulated method. Together they can be more capable than a worker with a laptop without becoming a company-owned artificial employee.

This extends the argument that professionals should own portable AI augmentation rather than surrender every improvement to whichever institution currently employs them ([SWE: Own Your Own AI][1]). If intelligence keeps improving quickly, the ownership layer around human+AI capability becomes one of the central institutional questions of the next decade ([2028 Intelligence Explosion][2]).

## The Boundary Problem

The difficult question is what belongs to the worker and what belongs to the company.
...
![A professional approaching a transparent gate between portable knowledge networks and institutional towers](./images/01__Market_for_Portable_Minds.webp)
...
The line is not clean today and will not become clean with AI. Labor markets already rely on imperfect distinctions between employee learning and trade secrets, professional growth and confidential information, tacit knowledge and theft. AI makes those distinctions explicit, machine-readable, and politically unavoidable.
...
There is one potential advantage: unlike a brain, a context layer can in principle be inspected and constrained.

## Context Escrow

A workable answer is more likely to involve negotiated portability with enforceable boundaries than total openness.

One possible model is a third-party context host, or context escrow. The individual keeps generalized context there while the company keeps specialized context inside its own systems. During hiring, the parties define what can flow between them. The company's agents access the worker's context through a control layer. Both sides can improve through the work without the company automatically absorbing the worker's entire portable system.
...
The idea sounds unfamiliar because the current system hides the same problem inside people. Contracts, confidentiality obligations, invention assignments, trade-secret law, norms, and litigation already police the boundary between employee learning and company ownership. The result is imperfect, expensive, and often unfair.
...
For companies, the main attraction is faster onboarding and execution.
...
AI systems grounded only in internal context can become intellectually inbred. They optimize current practice and inherit the company's blind spots. That is useful until current practice is the problem; then the agent repeats yesterday's assumptions with greater speed and confidence.
...
At its best, this is exchange rather than extraction: a repeatable way to turn specific work into generalized learning and apply generalized learning to new specific work. It will not produce a perfect division of value, because none exists now.

## Context as Credential

Hiring relies on noisy signals. Résumés compress a career into a favorable story, interviews reward fluency in an artificial setting, and references vary in candor. Work samples help, but only to a point.
...
AI will make some firms much more productive. The open question is whether that productivity remains locked inside institutional walls or circulates through the economy.
...
The centralized future is administratively attractive. It promises safety and efficiency while reducing the mess of markets, the friction of hiring, the ambiguity of work, and the leakage of learning.
...
AI does not abolish that bargain. It requires us to rebuild it with machinery attached.
...
The economy already depends on workers carrying what they learn. The task now is to build institutions that let them continue doing so safely when part of that learning is stored in an agent system.

## References

* [SWE: Own Your Own AI][1]
* [2028 Intelligence Explosion][2]
* [The Use of Knowledge in Society][3]
...
[1]: https://nikgo.com/pages/articles/SWE-own-your-own-ai.html
[2]: https://nikgo.com/pages/articles/2028_intelligence_explosion.html
[3]: https://www.econlib.org/library/Essays/hykKnw.html
[4]: https://onlinelibrary.wiley.com/doi/10.1111/j.1468-0335.1937.tb00002.x
[5]: https://press.uchicago.edu/ucp/books/book/chicago/H/bo3684031.html
[6]: https://www.hup.harvard.edu/books/9780674940529
[7]: https://openai.github.io/openai-agents-python/
[8]: https://docs.anthropic.com/en/docs/agents-and-tools/skills
