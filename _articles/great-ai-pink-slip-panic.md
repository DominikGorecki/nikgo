---
layout: article
title: "The Great AI Pink-Slip Panic (and Why the Commute Still Wins)"
description: "AI will disrupt particular roles, but labor, spending, and institutions can reallocate in ways that make economy-wide collapse less inevitable than the ‘Jobpocalypse’ narrative suggests."
permalink: /pages/articles/great-ai-pink-slip-panic.html
date: 2026-03-01
...
* **Software developers** (often assumed to be prime AI prey) are **up 5% in January vs. a year earlier**, roughly consistent with the longer trend (and the workforce is around **~2.5 million**).
* **Computer programmers** are **down slightly** over the last year, but that matches a **long secular decline** that predates this AI wave.
* Pay hasn’t cratered for new grads in the “code world,” either:

  * In **2024**, the **median young computer science graduate earned 63% more** than the typical young graduate, up from **47% in 2009**.
* Businesses didn’t stop buying software. They bought more:

  * **Business spending on software jumped 11% in Q4 vs. a year earlier**, the fastest in nearly three years.
...
* Consumers are **habit-addicted mammals**.
* In medicine, humans were supposed to vanish from the loop more than once. They didn’t—because people like explanations from other people.
* And here’s a great “humans didn’t vanish” stat: since a major translation app launched in **2006**, U.S. employment of **human translators/interpreters rose 73%**.
